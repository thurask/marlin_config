...
#define HOTEND_IDLE_TIMEOUT  // CUSTOMIZED_EDITED
  ...
  #define HOTEND_IDLE_MIN_TRIGGER   150     // (°C) Minimum temperature to enable hotend protection // CUSTOMIZED_EDITED
...
// @section bltouch
  ...
  //#define BLTOUCH_FORCE_SW_MODE  // CUSTOMIZED_EDITED
...
#define INPUT_SHAPING_Y  // CUSTOMIZED_EDITED
    ...
    #define SHAPING_FREQ_X  40.20          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  39.05          // (Hz) The default dominant resonant frequency on the Y axis.
...
#define SET_PROGRESS_MANUALLY
  ...
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done, otherwise use Marlin's estimate  // CUSTOMIZED_EDITED
  #define SET_REMAINING_TIME            // Add 'R' parameter to set remaining time, otherwise use Marlin's estimate  // CUSTOMIZED_EDITED
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY  // CUSTOMIZED_EDITED
    ...
    //#define BACKUP_POWER_SUPPLY         // Backup power / UPS to move the steppers on power loss  // CUSTOMIZED_EDITED
  ...
  //#define BINARY_FILE_TRANSFER  // CUSTOMIZED_EDITED

  #if ENABLED(BINARY_FILE_TRANSFER)
    // Include extra facilities (e.g., 'M20 F') supporting firmware upload via BINARY_FILE_TRANSFER
    #define CUSTOM_FIRMWARE_UPLOAD  // CUSTOMIZED_EDITED
  #endif
...
#define TX_BUFFER_SIZE 128  // CUSTOMIZED_EDITED
...
#define FWRETRACT  // CUSTOMIZED_EDITED
  ...
  //#define FWRETRACT_AUTORETRACT             // Override slicer   // CUSTOMIZED_EDITED
...
#define ADVANCED_PAUSE_FEATURE
  ...
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change  // CUSTOMIZED_EDITED
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define Z_CURRENT       1160  // dual Z in parallel; translates to 1.64A through the driver and 0.82A through each motor // CUSTOMIZED_EDITED
  ...
  #define DIAG_JUMPERS_REMOVED  // to get Platformio to stop breathing down my back CUSTOMIZED_EDITED

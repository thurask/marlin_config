...
#define Z_STEPPER_AUTO_ALIGN // CUSTOMIZED_EDITED
   ...
   */
  //#define Z_STEPPER_ALIGN_XY { {  95, 128 }, { 225,  128 }} // left edge, right edge
...
//#define FT_MOTION
  ...
  #define FTM_LINEAR_ADV_DEFAULT_K      0.0f      // Default linear advance gain, integer value. (Acceleration-based scaling factor.)
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define PROBE_OFFSET_WIZARD         // Add a Probe Z Offset calibration option to the LCD menu // CUSTOMIZED_EDITED
 ...
 */
  ...
  //#define CHOPPER_TIMING_Z  CHOPPER_TIMING        // For Z Axes (override below) // 0.9 degree motor // CUSTOMIZED_EDITED

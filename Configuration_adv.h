 ...
 */
//#define USE_CONTROLLER_FAN // FAN0 and FAN1: controllable (cooler, hotend); FAN: always on (board) // CUSTOMIZED_EDITED
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // CUSTOMIZED_EDITED
 ...
 */
#if ENABLED(HAS_MEDIA) && DISABLED(NO_SD_HOST_DRIVE)
 ...
 */
#define BABYSTEPPING // CUSTOMIZED_EDITED
#if ENABLED(BABYSTEPPING)
  #define INTEGRATED_BABYSTEPPING           // Integration of babystepping into the Stepper ISR // CUSTOMIZED_EDITED
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  5       // (steps or mm) Steps or millimeter distance for each Z babystep // CUSTOMIZED_EDITED
...
#define LIN_ADVANCE // CUSTOMIZED_EDITED
  ...
  #else
    #define ADVANCE_K 0.0         // (mm) Compression length applying to all extruders // COME BACK TO THIS // CUSTOMIZED_EDITED
  #endif
...
#define ADVANCED_PAUSE_FEATURE // CUSTOMIZED_EDITED
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      450  // (mm) The length of filament for a complete unload. // CUSTOMIZED_EDITED
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   350  // (mm) Load length of filament, from extruder gear to nozzle. // CUSTOMIZED_EDITED
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       580        // (mA) RMS current. Multiply by 1.414 for peak current. // CUSTOMIZED_EDITED
    ...
    #define Y_CURRENT       580 // CUSTOMIZED_EDITED
    ...
    #define Z_CURRENT       580 // CUSTOMIZED_EDITED
    ...
    #define E0_CURRENT      700 // CUSTOMIZED_EDITED
 ...
 */
#define AUTO_REPORT_POSITION  // CUSTOMIZED_EDITED

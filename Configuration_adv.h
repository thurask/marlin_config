 ...
 */
  ...
  #define ADAPTIVE_FAN_SLOWING              // Slow down the part-cooling fan if the temperature drops // CUSTOMIZED_EDITED
  #if ENABLED(ADAPTIVE_FAN_SLOWING)
    #define REPORT_ADAPTIVE_FAN_SLOWING     // Report fan slowing activity to the console // CUSTOMIZED_EDITED
    #if ANY(MPCTEMP, PIDTEMP)
      #define TEMP_TUNING_MAINTAIN_FAN      // Don't slow down the fan speed during M303 or M306 T // CUSTOMIZED_EDITED
    #endif
  #endif
 ...
 */
#define HOTEND_IDLE_TIMEOUT // CUSTOMIZED_EDITED
#if ENABLED(HOTEND_IDLE_TIMEOUT)
  #define HOTEND_IDLE_TIMEOUT_SEC (15*60)   // (seconds) Time without extruder movement to trigger protection // CUSTOMIZED_EDITED
 ...
 */
#define USE_CONTROLLER_FAN  // Nevermore filter; full bore when not printing, off when printing // CUSTOMIZED_EDITED
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN       FAN2_PIN // Set a custom pin for the controller fan // CUSTOMIZED_EDITED
  //#define CONTROLLER_FAN2_PIN -1          // Set a custom pin for second controller fan
  //#define CONTROLLER_FAN_USE_Z_ONLY       // With this option only the Z axis is considered
  //#define CONTROLLER_FAN_IGNORE_Z         // Ignore Z stepper. Useful when stepper timeout is disabled.
  #define CONTROLLERFAN_SPEED_MIN         0 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
  #define CONTROLLERFAN_SPEED_ACTIVE      0 // (0-255) Active speed, used when any motor is enabled // CUSTOMIZED_EDITED
  #define CONTROLLERFAN_SPEED_IDLE      255 // (0-255) Idle speed, used when motors are disabled // CUSTOMIZED_EDITED
  #define CONTROLLERFAN_IDLE_TIME         0 // (seconds) Extra time to keep the fan running after disabling motors // CUSTOMIZED_EDITED
  ...
  #define CONTROLLER_FAN_EDITABLE         // Enable M710 configurable settings  // CUSTOMIZED_EDITED
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // FAN0 = part cooler; FAN1 = extruder; FAN2 = controller   // CUSTOMIZED_EDITED
...
#define QUICK_HOME                            // If G28 contains XY do a diagonal move first // CUSTOMIZED_EDITED
 ...
 */
#define Z_STEPPER_AUTO_ALIGN // CUSTOMIZED_EDITED
   ...
   */
  //#define Z_STEPPER_ALIGN_XY { {  95, 128 }, { 225,  128 }} // left edge, right edge // CUSTOMIZED_EDITED
   ...
   */
    ...
    #define Z_STEPPERS_ORIENTATION 0 // CUSTOMIZED_EDITED
  #endif
...
//#define ASSISTED_TRAMMING
   ...
   */
  #define TRAMMING_SCREW_THREAD M4_CW // CUSTOMIZED_EDITED
 ...
 */
#define INPUT_SHAPING_X // CUSTOMIZED_EDITED
#define INPUT_SHAPING_Y // CUSTOMIZED_EDITED
//#define INPUT_SHAPING_Z
  ...
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters. // CUSTOMIZED_EDITED
#endif
...
#define SLOWDOWN
#if ENABLED(SLOWDOWN)
  #define SLOWDOWN_DIVISOR 4 // CUSTOMIZED_EDITED
#endif
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING // CUSTOMIZED_EDITED
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD         // CUSTOMIZED_EDITED
    ...
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER } // CUSTOMIZED_EDITED
  #endif
#endif
  ...
  #define LCD_INFO_MENU // CUSTOMIZED_EDITED
  #if ENABLED(LCD_INFO_MENU)
    //#define LCD_PRINTER_INFO_IS_BOOTSCREEN // Show bootscreen(s) instead of Printer Info pages
    #define BUILD_INFO_MENU_ITEM           // Add a menu item to display the build date and time  // CUSTOMIZED_EDITED
  #endif
  ...
  #define PREHEAT_SHORTCUT_MENU_ITEM // CUSTOMIZED_EDITED

  // Add Configuration > Debug Menu > Endstop Test for endstop/probe/runout testing
  #define LCD_ENDSTOP_TEST // CUSTOMIZED_EDITED
  ...
  #define SHOW_BOOTSCREEN                 // Show the Marlin bootscreen on startup. ** ENABLE FOR PRODUCTION **
    ...
    #define BOOTSCREEN_TIMEOUT 3000       // (ms) Total Duration to display the boot screen(s)
      ...
      //#define BOOT_MARLIN_LOGO_SMALL      // Show a smaller Marlin logo on the Boot Screen (saving lots of flash) // CUSTOMIZED_EDITED
    #endif
    #if HAS_MARLINUI_U8GLIB
      #define BOOT_MARLIN_LOGO_ANIMATED // Animated Marlin logo. Costs ~3260 (or ~940) bytes of flash. // CUSTOMIZED_EDITED
    #endif
    #if ANY(HAS_MARLINUI_U8GLIB, TOUCH_UI_FTDI_EVE, HAS_MARLINUI_HD44780)
      #define SHOW_CUSTOM_BOOTSCREEN    // Show the bitmap in Marlin/_Bootscreen.h on startup. // CUSTOMIZED_EDITED
    #endif
  #endif

  #if HAS_MARLINUI_U8GLIB
    #define CUSTOM_STATUS_SCREEN_IMAGE  // Show the bitmap in Marlin/_Statusscreen.h on the status screen. // CUSTOMIZED_EDITED
  #endif
  ...
  #define STATUS_MESSAGE_SCROLLING // CUSTOMIZED_EDITED
   ...
   */
  #define LED_CONTROL_MENU // CUSTOMIZED_EDITED
  #if ENABLED(LED_CONTROL_MENU)
    #define LED_COLOR_PRESETS                 // Enable the Preset Color menu option
    #define NEO2_COLOR_PRESETS                // Enable a second NeoPixel Preset Color menu option // UCUSTOMIZED_EDITED
    #if ENABLED(LED_COLOR_PRESETS)
      #define LED_USER_PRESET_RED        255  // User defined RED value
      #define LED_USER_PRESET_GREEN      255  // User defined GREEN value // CUSTOMIZED_EDITED
      #define LED_USER_PRESET_BLUE       255  // User defined BLUE value // CUSTOMIZED_EDITED
      #define LED_USER_PRESET_WHITE      255  // User defined WHITE value
      #define LED_USER_PRESET_BRIGHTNESS 255  // User defined intensity
      #define LED_USER_PRESET_STARTUP         // Have the printer display the user preset color on startup // CUSTOMIZED_EDITED
    #endif
    #if ENABLED(NEO2_COLOR_PRESETS)
      #define NEO2_USER_PRESET_RED        255 // User defined RED value
      #define NEO2_USER_PRESET_GREEN      255 // User defined GREEN value // CUSTOMIZED_EDITED
      #define NEO2_USER_PRESET_BLUE       255 // User defined BLUE value // CUSTOMIZED_EDITED
      #define NEO2_USER_PRESET_WHITE      255 // User defined WHITE value
      #define NEO2_USER_PRESET_BRIGHTNESS  64 // User defined intensity
      #define NEO2_USER_PRESET_STARTUP        // Have the printer display the user preset color on startup for the second strip // CUSTOMIZED_EDITED
    #endif
  #endif
...
#define SET_PROGRESS_MANUALLY // CUSTOMIZED_EDITED
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done
  #define SET_REMAINING_TIME              // Add 'R' parameter to set remaining time
  #define SET_INTERACTION_TIME          // Add 'C' parameter to set time until next filament change or other user interaction // CUSTOMIZED_EDITED
  #define M73_REPORT                    // Report M73 values to host // CUSTOMIZED_EDITED
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME             // Display estimated time to completion (prefix 'R') // CUSTOMIZED_EDITED
  ...
  #define EVENT_GCODE_SD_ABORT "G28XY\nM84" // G-code to run on SD Abort Print (e.g., "G28XY" or "G27") // CUSTOMIZED_EDITED
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY // CUSTOMIZED_EDITED
   ...
   */
  #define SDCARD_SORT_ALPHA // CUSTOMIZED_EDITED
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    true   // Pre-allocate a static array for faster pre-sorting. // CUSTOMIZED_EDITED
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true   // Keep sorted items in RAM longer for speedy performance. Most expensive option. // CUSTOMIZED_EDITED
    #define SDSORT_DYNAMIC_RAM true   // Use dynamic allocation (within SD menus). Least expensive option. Set SDSORT_LIMIT before use! // CUSTOMIZED_EDITED
  ...
  #define LONG_FILENAME_HOST_SUPPORT      // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' // CUSTOMIZED_EDITED
  #define LONG_FILENAME_WRITE_SUPPORT     // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol // CUSTOMIZED_EDITED
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES           // Scroll long filenames in the SD card menu // CUSTOMIZED_EDITED
  ...
  #define AUTO_REPORT_SD_STATUS           // Auto-report media status with 'M27 S<seconds>' // CUSTOMIZED_EDITED
   ...
   */
  #define CONFIGURATION_EMBEDDING // CUSTOMIZED_EDITED
  #define NO_CONFIGURATION_EMBEDDING_WARNING // suppress warning // CUSTOMIZED_EDITED
   ...
   */
  #define SDCARD_CONNECTION LCD // Required for LCD contrast to be initialized correctly. Onboard SD is inaccessible. // CUSTOMIZED_EDITED
 ...
 */
  ...
  #define STATUS_HEAT_PERCENT         // Show heating in a progress bar // CUSTOMIZED_EDITED
  ...
  //#define MARLIN_SNAKE
  //#define GAMES_EASTER_EGG          // Add extra blank lines above the "Games" sub-men
#endif
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  2       // (steps or mm) Steps or millimeter distance for each Z babystep // CUSTOMIZED_EDITED
  #define BABYSTEP_MULTIPLICATOR_XY 1       // (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping. // CUSTOMIZED_EDITED
  #if ENABLED(DOUBLECLICK_FOR_Z_BABYSTEPPING)
    #define DOUBLECLICK_MAX_INTERVAL 1250   // (ms) Maximum interval between clicks.
                                            // Note: Extra time may be added to mitigate controller latency.
    #define MOVE_Z_WHEN_IDLE                // Jump to the move Z menu on double-click when printer is idle. // CUSTOMIZED_EDITED
    #if ENABLED(MOVE_Z_WHEN_IDLE)
      #define MOVE_Z_IDLE_MULTIPLICATOR 2   // Multiply 1mm by this factor for the move step size. // CUSTOMIZED_EDITED
    #endif
  #endif

  //#define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28

  #define BABYSTEP_ZPROBE_OFFSET            // Combine M851 Z and Babystepping // CUSTOMIZED_EDITED
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_GFX_OVERLAY            // Enable graphical overlay on Z-offset editor // CUSTOMIZED_EDITED
  #endif
#endif
 ...
 */
#define LIN_ADVANCE // CUSTOMIZED_EDITED
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.0 }     // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.0         // (mm) Compression length applying to all extruders // CUSTOMIZED_EDITED
  #endif
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define ARC_P_CIRCLES               // Enable the 'P' parameter to specify complete circles // CUSTOMIZED_EDITED
  //#define SF_ARC_FIX                // Enable only if using SkeinForge with "Arc Point" fillet procedure
#endif

// G5 Bézier Curve Support with XYZE destination and IJPQ offsets
#define BEZIER_CURVE_SUPPORT        // Requires ~2666 bytes // CUSTOMIZED_EDITED
...
#elif HAS_MEDIA
  #define BLOCK_BUFFER_SIZE 64 // CUSTOMIZED_EDITED
#else
...
#define BUFSIZE 32 // CUSTOMIZED_EDITED
 ...
 */
#define TX_BUFFER_SIZE 256 // CUSTOMIZED_EDITED
 ...
 */
#define RX_BUFFER_SIZE 2048 // CUSTOMIZED_EDITED

#if RX_BUFFER_SIZE >= 1024
  // Enable to have the controller send XON/XOFF control characters to
  // the host to signal the RX buffer is becoming full.
  #define SERIAL_XON_XOFF // CUSTOMIZED_EDITED
#endif
 ...
 */
#define EMERGENCY_PARSER // CUSTOMIZED_EDITED
 ...
 */
#define REALTIME_REPORTING_COMMANDS // CUSTOMIZED_EDITED
...
#define ADVANCED_OK // CUSTOMIZED_EDITED
 ...
 */
#define ADVANCED_PAUSE_FEATURE // CUSTOMIZED_EDITED
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         30  // (mm/s) Initial retract feedrate. // CUSTOMIZED_EDITED
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     30  // (mm/s) Unload filament feedrate. This can be pretty fast. // CUSTOMIZED_EDITED
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      490  // (mm) The length of filament for a complete unload. // CUSTOMIZED_EDITED
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   6  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    25  // (mm) Slow length, to allow time to insert material. // CUSTOMIZED_EDITED
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  25  // (mm/s) Load filament feedrate. This can be pretty fast. // CUSTOMIZED_EDITED
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   490  // (mm) Load length of filament, from extruder gear to nozzle. // CUSTOMIZED_EDITED
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        5  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate. // CUSTOMIZED_EDITED
  ...
  #define PARK_HEAD_ON_PAUSE                      // Park the nozzle during pause and filament change. // CUSTOMIZED_EDITED
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES             // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. // CUSTOMIZED_EDITED
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define TMC2240_RREF        12000   // (Ω) 12000 .. 60000. (FLY TMC2240 = 12300)Add commentMore actions
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) // CUSTOMIZED_EDITED
  #define CHOPPER_TIMING_X  CHOPPER_09STEP_24V      // For X Axes (override below) // 0.9 degree motor // CUSTOMIZED_EDITED
  //#define CHOPPER_TIMING_X2 CHOPPER_TIMING_X
  #define CHOPPER_TIMING_Y  CHOPPER_09STEP_24V      // For Y Axes (override below) // 0.9 degree motor // CUSTOMIZED_EDITED
  //#define CHOPPER_TIMING_Y2 CHOPPER_TIMING_Y
  //#define CHOPPER_TIMING_Z  CHOPPER_TIMING        // For Z Axes (override below) // 1.8 degree motor // CUSTOMIZED_EDITED
  //#define CHOPPER_TIMING_Z2 CHOPPER_TIMING_Z      // 1.8 degree motor // CUSTOMIZED_EDITED
  ...
  #define CHOPPER_TIMING_E  CHOPPER_09STEP_24V      // For Extruders (override below) // 0.9 degree motor // CUSTOMIZED_EDITED
   ...
   */
  #define MONITOR_DRIVER_STATUS // CUSTOMIZED_EDITED
   ...
   */
  #define TMC_DEBUG // CUSTOMIZED_EDITED
 ...
 */
#define M114_DETAIL         // Use 'M114 D' for details to check planner calculations // CUSTOMIZED_EDITED
#define M114_REALTIME       // Real current position based on forward kinematics // CUSTOMIZED_EDITED
...
#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others) // CUSTOMIZED_EDITED
...
#define FASTER_GCODE_PARSER
  ...
  #define GCODE_QUOTED_STRINGS  // Support for quoted string parameters // CUSTOMIZED_EDITED
#endif

/**
 * Support for MeatPack G-code compression (https://github.com/scottmudge/OctoPrint-MeatPack)
 */
//#define MEATPACK_ON_SERIAL_PORT_1 // SKR3 WiFi (3) or TFT (-1) CUSTOMIZED_EDITED
#define MEATPACK_ON_SERIAL_PORT_2 // SKR3 USB CUSTOMIZED_EDITED
 ...
 */
#define GCODE_MACROS // CUSTOMIZED_EDITED
 ...
 */
#define HOST_ACTION_COMMANDS // CUSTOMIZED_EDITED
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT             // Initiate host prompts to get user feedback // CUSTOMIZED_EDITED
  #if ENABLED(HOST_PROMPT_SUPPORT)
    //#define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications
  #endif
  #define HOST_START_MENU_ITEM          // Add a menu item that tells the host to start // CUSTOMIZED_EDITED
  #define HOST_SHUTDOWN_MENU_ITEM       // Add a menu item that tells the host to shut down // CUSTOMIZED_EDITED
#endif

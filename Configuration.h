...
#define STRING_CONFIG_H_AUTHOR "(Thurask, Ender 3 Pro SKR3 EZ)" // Original author or contributor. // CUSTOMIZED_EDITED
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.013  // (mm) Distance from real junction edge // CUSTOMIZED_EDITED

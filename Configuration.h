...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 209.32
  #define DEFAULT_bedKi 40.88
  #define DEFAULT_bedKd 714.47
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 99.27168 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47.8, -5.8, 0 }
...
#define Y_BED_SIZE 235  // the Y-axis tensioner cuts off some printable area

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 10 // extra room to maneuver
